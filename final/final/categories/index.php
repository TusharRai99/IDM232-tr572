...
<body>
          <div class="hero">
               <h2 class="hero_text">PICK A CATEGORY </h2>
               <!--<hr class="hero_break">-->
               <div>
                    <a href="<?php echo $app['url'];?>/final/categories/index.php?keyword=breakfast" class="btn" value="<?php echo @$_GET['keyword']; ?>">Breakfast</a>
                    <a href="<?php echo $app['url'];?>/final/categories/index.php?keyword=lunch" class="btn" value="<?php echo @$_GET['keyword']; ?>">Lunch</a>
                    <a href="<?php echo $app['url'];?>/final/categories/index.php?keyword=dinner" class="btn" value="<?php echo @$_GET['keyword']; ?>">Dinner</a>
                    <a href="<?php echo $app['url'];?>/final/categories/index.php?keyword=dessert" class="btn" value="<?php echo @$_GET['keyword']; ?>">Dessert</a>
