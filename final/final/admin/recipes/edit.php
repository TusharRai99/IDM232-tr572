...
if (isset($_POST['update'])) {
  ...
  if ($_GET['id'] != $id) {
    redirectTo('/final/admin/recipes/edit.php?id=' . $_GET['id'] . '&error=User ID does not match current user.');
  }
  //  Parse Data
  ...
  if ($db_results) {
    // Success
    redirectTo('/final/admin/recipes?success=Recipe Updated');
  } else {
    // Error
    redirectTo('/final/admin/recipes/edit.php?id=' . $id . '&error=' . mysqli_error($db_connection));
  }
  ...
  if ($db_results) {
    ...
    redirectTo('/final/admin/recipes?error=' . mysqli_error($db_connection));
  }
} else {
  // Redirect user if no ID is passed in URL
  redirectTo('/final/admin/recipes');
}
?>
<div class="container">
  ...
  <form action="" method="POST">
    ...
    <input type="text" value="<?php echo $recipe['recipe_name']; ?>" name="recipe_name">
    ...
    <textarea type="text" id="mytextarea" name="intro"><?php echo $recipe['intro']; ?></textarea>

    <label for="">Ingredients</label>
    <textarea type="text" id="mytextarea" name="ingredients"><?php echo $recipe['ingredients']; ?></textarea>


    <label for="">Description</label>
    <textarea type="text" id="mytextarea" name="description"><?php echo $recipe['description']; ?></textarea>
