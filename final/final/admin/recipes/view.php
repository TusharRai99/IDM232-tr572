...
<div class="individual">
    <div class="individual_left">
        ...
        <img class="individual_img" src="/final/dist/images/placeholder.jpg">
        <!--<img class="comment_img" src="../images/comment.png">-->
    </div>
    <div class="individual_right">
        <div class="container">
            <p><a class="btn btn-primary" href="/final/admin/recipes/edit.php?id=<?php echo $recipe['id']; ?>">Edit</a>
                <a class="btn btn-secondary" href="/final/admin/recipes/delete.php?id=<?php echo $recipe['id']; ?>">Delete</a>
            </p>
        </div>
